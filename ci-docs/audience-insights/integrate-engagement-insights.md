...
Šiame pavyzdyje tarkime, kad aplinkoje yra vieningų klientų profilių. Profiliai buvo suvienoduoti su apklausų, mažmeninės prekybos ir bilietų pardavimo sistemos šaltiniais. Čia taip pat rodoma susijusi klientų veikla. 
...
- Norint eksportuoti žiniatinklio įvykius iš įtraukimo įžvalgų, būtina prieiga prie "ADLS Gen 2" saugyklos paskyros, kuri bus naudojama žiniatinklio įvykių duomenims perteiti į auditorijos įžvalgas. Daugiau informacijos ieškokite [Terminų atnaujinimas](../engagement-insights/export-events.md).
...
Aspektai kuriant tobulintimus įvykius: 
...
- Jei norite kurti veiklą auditorijos įžvalgose, pasirinkite bent šias ypatybes: 
    - Signal.Action.Name – veiklos išsami informacija
...
Daugiau informacijos žr. [Prisijungimas prie bendro duomenų modelio aplanko naudojant "Azure Data Azure Data Lake" paskyrą](connect-common-data-model.md)
...
Dabar galite kurti [segmentus](segments.md),  ir [priemones](measures.md)[prognozes, ](predictions.md), kad ryšys su klientais būtų prasmingas.
