...
### <a name="option-2-use-download-link"></a>2 parinktis: atsisiuntimo saito naudojimas
...
1. (pasirinktinis) Kitos konfigūracijos, pvz., galinių punktų išseksavimo URL nustatymas. Juos galima pridėti po nurijimo rakto metaduomenimis, esant `AndroidManifest.xml`.
